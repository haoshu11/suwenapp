...
const api = [
  {
    ...
    pages: [
      ...
      {
        name: "监听app启动事件 tt.onAppLaunch",
        path: "tt-on-app-launch/tt-on-app-launch",
      },
      {
        name: "取消监听app启动事件 tt.offAppLaunch",
        path: "tt-off-app-launch/tt-off-app-launch",
      },
      {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: "获取流量归因参数 tt.getAnalysisInfo ",
        path: "tt-get-analysis-info/tt-get-analysis-info",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: "取消监听网络状态 OffNetworkStatusChange",
        path: "tt-off-network-status-change/tt-off-network-status-change",
      },
      {
      ...
      {
        name: "取消监听加速度计数据 OffAccelerometerChange",
        path: "tt-off-accelerometer-change/tt-off-accelerometer-change",
      },
      {
      ...
      {
        name: "取消监听罗盘数据 OffCompassChange",
        path: "tt-off-compass-change/tt-off-compass-change",
      },
      {
        name: "扫码 ScanCode",
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: '开启小程序页面返回询问对话框',
        path: 'tt-enable-alert-before-unload/tt-enable-alert-before-unload',
      },
      {
        name: "显示消息提示框 Toast",
      ...
      {
        name: '获取自定义导航栏下不可变元素的位置信息 GetCustomButtonBoundingClientRect',
  ...
  },
  {
    ...
    pages: [
      {
        name: "跳转侧边栏 tt-navigate-to-scene",
        path: "tt-navigate-to-scene/tt-navigate-to-scene",
      },
      {
        name: "获取福利活动id tt-get-sidebar-activity",
        path: "tt-get-sidebar-activity/tt-get-sidebar-activity",
      },
    ],
  },
  {
...
const components = [
  ...
  },
  {
    ...
    pages: [
      ...
      {
        name: "跳转平台客服 platform-im",
        path: "button-platform-im/button-platform-im",
      },
      {
        name: "跳转视频播放页 navigate-to-video-view",
        path: "button-navigate-to-video-view/button-navigate-to-video-view",
      },
      {
        name: "跳转抖音号个人页 open-aweme-user-profile",
        path: "button-open-aweme-user-profile/button-open-aweme-user-profile",
      },
      {
        name: "跳转抖音直播间 open-webcast-room",
        path: "button-open-webcast-room/button-open-webcast-room",
      },
      {
        name: "关注抖音号组件 aweme-user-card",
        path: "aweme-user-card/aweme-user-card",
      },
      {
        name: "直播间状态组件 aweme-data",
        path: "aweme-data/aweme-data",
      },
      {
        name: "直播预览流组件 live-preview",
        path: "live-preview/live-preview",
      },
      {
        name: "私聊 private-message",
        path: "button-private-message/button-private-message",
      },
      {
        name: "主动授权私信 authorize-private-message",
        path: "button-authorize-private-message/button-authorize-private-message",
      },
      {
        name: "添加日历事件 add-calendar-event",
        path: "button-add-calendar-event/button-add-calendar-event",
      },
      {
        name: "添加桌面快捷方式 add-shortcut",
        path: "button-add-shortcut/button-add-shortcut",
      },
    ],
  },
];
